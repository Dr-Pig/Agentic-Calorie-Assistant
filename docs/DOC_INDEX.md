...
- retired V2/Wave planning packs must not be tracked under active `docs/specs/` or `docs/quality/`
...
| Current Shell self-use Golden Set and machine-readable EDD manifest | [docs/quality/CURRENT_SHELL_SELF_USE_GOLDEN_SET_SPEC.md](quality/CURRENT_SHELL_SELF_USE_GOLDEN_SET_SPEC.md), [docs/quality/current_shell_self_use_golden_set_manifest.yaml](quality/current_shell_self_use_golden_set_manifest.yaml) |
| Manager prompt architecture, ownership, and reference implementation alignment | [docs/specs/MANAGER_RUNTIME_PROMPT_ARCHITECTURE_AND_OWNERSHIP_SPEC.md](specs/MANAGER_RUNTIME_PROMPT_ARCHITECTURE_AND_OWNERSHIP_SPEC.md), [docs/quality/CURRENT_SHELL_AGENTIC_EDD_STANDARD.md](quality/CURRENT_SHELL_AGENTIC_EDD_STANDARD.md) |
...
| advanced product lab reference docs on `main` | dormant or merge-back-safe review only; branch-local bootstrap lives in `codex/advanced-product-lab` `AGENTS.md`, not in main `AGENTS.md` |
...
- retired V2/Wave planning packs preserved under `docs/_spec_snapshots/legacy_v2_wave_pack_20260515/`
