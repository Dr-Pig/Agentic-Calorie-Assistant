...
| advanced product lab trains, golden sets, activation wall, and mechanism references | [docs/quality/ADVANCED_PRODUCT_LAB_INDEX.md](quality/ADVANCED_PRODUCT_LAB_INDEX.md) |
