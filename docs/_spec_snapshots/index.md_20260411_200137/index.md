...
This directory is the repository system of record.

Start here if you need the current product truth, runtime truth, or build plan.
...
6. [L6D LLM Pass Design Policy Spec](/C:/Users/User/Documents/Playground/line-liff-calorie-helper-text-meal-canary-main/docs/specs/L6D_LLM_PASS_DESIGN_POLICY_SPEC.md)
...
- [L6D LLM Pass Design Policy Spec](/C:/Users/User/Documents/Playground/line-liff-calorie-helper-text-meal-canary-main/docs/specs/L6D_LLM_PASS_DESIGN_POLICY_SPEC.md)
...
Current work plans live in [`docs/exec-plans/active/`](/C:/Users/User/Documents/Playground/line-liff-calorie-helper-text-meal-canary-main/docs/exec-plans/active).
...
Completed plans should move to [`docs/exec-plans/completed/`](/C:/Users/User/Documents/Playground/line-liff-calorie-helper-text-meal-canary-main/docs/exec-plans/completed).

## Supporting Governance

These docs support the repository operating model:
...
Current runtime and operator handoff docs live in [`docs/handoff/`](/C:/Users/User/Documents/Playground/line-liff-calorie-helper-text-meal-canary-main/docs/handoff).
