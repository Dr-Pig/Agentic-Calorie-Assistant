# Legacy Pre-Self-Use Runtime Reference Index

This is the sole active legacy runtime reference index for the repository.

Use this file only when a task explicitly needs historical pre-Current-Shell runtime planning or compatibility-era harness interpretation.

This file is not an active bootstrap.

## Use When

Read this file only when the task needs:

- historical architecture interpretation
- compatibility with older harness, tests, or scripts
- back-reference for pre-self-use runtime docs

Do not use this file as the default entrypoint for new windows.
...
- `Current Shell` split delivery for the `Calorie Deficit Logging MVP local self-use foundation`

New windows should start from:

1. `AGENTS.md`
2. `docs/DOC_INDEX.md`
3. `docs/specs/APP_ENGINEERING_OPERATING_ENTRY.md`
4. `docs/quality/ACCURATE_INTAKE_PARALLEL_TRACKS_STATUS.md`
5. `docs/quality/CURRENT_SHELL_SYNC_CONTRACT.yaml`
6. `docs/quality/MANAGER_RUNTIME_GATE_LEDGER.yaml`
