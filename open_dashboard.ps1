# Canary Insight Dashboard - One Click Launcher
# This script checks if the server is running and opens the dashboard in your default browser.
...
if ($activePort) {
    Write-Host "[SYSTEM] Server is already running. Opening Dashboard..." -ForegroundColor Green
    Start-Process $url
} else {
