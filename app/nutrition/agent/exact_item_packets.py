...
def _fallback_exact_candidates(*, search_query: str, required_slots: list[str] | None, limit: int) -> list[dict[str, Any]]:
...
def resolve_exact_item(
    ...
    *,
    ...
    return _fallback_exact_candidates(search_query=search_query, required_slots=required_slots, limit=limit)
