...
def build_manager_react_trace(
    *,
    ...
    return {
        ...
        "manager_pass_1": _round_summary(manager_rounds[0]) if manager_rounds else None,
        "requested_tools": requested_tools,
        "executed_tools": executed_tools,
        "manager_pass_final": _round_summary(manager_rounds[-1]) if manager_rounds else None,
