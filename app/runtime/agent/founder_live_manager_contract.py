...
def founder_live_manager_tool_description() -> str:
    return (
        ...
        "hard-delete, whole-meal undo, or rely on deterministic raw text routing. For a composition-unknown "
        "self-selected basket, return final ask_followup directly, use tool_calls=[] for composition-unknown "
