...
FOUNDER_LIVE_MANAGER_REPAIR_REQUIRED_TOOL_BY_FAMILY = {FOUNDER_LIVE_MANAGER_COMMIT_WITHOUT_EVIDENCE_REPAIR_FAMILY: "estimate_nutrition", "nutrition_evidence_unavailable": "estimate_nutrition", FOUNDER_LIVE_MANAGER_BODY_OBSERVATION_MISSING_TOOL_REPAIR_FAMILY: "body.record_observation"}
