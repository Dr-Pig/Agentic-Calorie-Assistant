...
from .manager_branch_constraints import (
    B1_COMMON_FOOD_ITEM_CASE_FAMILY as B1_COMMON_FOOD_ITEM_CASE_FAMILY,
    B1_COMPOSITION_UNKNOWN_CASE_FAMILY as B1_COMPOSITION_UNKNOWN_CASE_FAMILY,
    B1_LISTED_INGREDIENT_CASE_FAMILY as B1_LISTED_INGREDIENT_CASE_FAMILY,
)
from .phase_b1_profile_route_rules import select_phase_b1_local_diagnostic_route_rule
from .phase_b1_selection_specs import (
    FORCED_MODE as FORCED_MODE,
    NATURAL_MODE,
    ...
    PHASE_B1_PASS_1_COMMON_COMMERCIAL_DRINK_ID as PHASE_B1_PASS_1_COMMON_COMMERCIAL_DRINK_ID,
    PHASE_B1_PASS_1_COMMON_COMMERCIAL_MEAL_ID as PHASE_B1_PASS_1_COMMON_COMMERCIAL_MEAL_ID,
    PHASE_B1_PASS_1_COMMON_FOOD_ITEM_ID as PHASE_B1_PASS_1_COMMON_FOOD_ITEM_ID,
    PHASE_B1_PASS_1_FORCED_ID as PHASE_B1_PASS_1_FORCED_ID,
    PHASE_B1_PASS_1_NATURAL_FALLBACK_ID as PHASE_B1_PASS_1_NATURAL_FALLBACK_ID,
    PHASE_B1_PASS_2_B1_004_CLARIFY_ONLY_ID as PHASE_B1_PASS_2_B1_004_CLARIFY_ONLY_ID,
    PHASE_B1_PASS_2_COMMON_COMMERCIAL_DRINK_ID as PHASE_B1_PASS_2_COMMON_COMMERCIAL_DRINK_ID,
    PHASE_B1_PASS_2_COMMON_COMMERCIAL_MEAL_ID as PHASE_B1_PASS_2_COMMON_COMMERCIAL_MEAL_ID,
    PHASE_B1_PASS_2_COMMON_FOOD_ITEM_ID as PHASE_B1_PASS_2_COMMON_FOOD_ITEM_ID,
    PHASE_B1_PASS_2_GENERIC_ID as PHASE_B1_PASS_2_GENERIC_ID,
    PHASE_B1_PASS_2_LISTED_INGREDIENT_ID as PHASE_B1_PASS_2_LISTED_INGREDIENT_ID,
