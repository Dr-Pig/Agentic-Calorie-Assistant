...
SHORT_TERM_TRUE_FIELD_BLOCKERS = {
    ...
    "today_no_meal_before_followup_answer": "today_meal_logged_before_followup_answer",
    "today_consumed_zero_before_followup_answer": "today_consumed_before_followup_answer",
