...
def test_manager_read_only_tool_choice_runtime_smoke_covers_current_shell_read_only_cases() -> None:
    ...
    assert artifact["artifact_type"] == "accurate_intake_manager_read_only_public_tool_runtime_smoke"
    assert artifact["status"] == "manager_read_only_public_tool_runtime_smoke_pass"
...
def test_manager_read_only_tool_choice_runtime_smoke_uses_public_tool_results_and_no_mutation() -> None:
    ...
    for case in cases.values():
        ...
        assert case["state_mutation"]["observed_no_mutation"] is True
        assert case["state_mutation"]["before"] == case["state_mutation"]["after"]
