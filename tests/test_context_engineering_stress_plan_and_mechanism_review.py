...
def test_context_engineering_stress_pr_train_records_dynamic_slice_plan() -> None:
    ...
    assert plan["dynamic_remaining_slice_count"] == 7
    ...
    assert plan["last_completed_slice_number"] == 9
    assert plan["last_merge_evidence"]["completed_slices"][-1] == {
        "slice_number": 9,
        "slice_id": "multi_capability_manager_turn_plan_grader",
        "result": "manager_turn_plan_grader_completed",
        "artifact": "app/advanced_shadow_lab/context_engineering_trace_grader.py",
        "dynamic_remaining_slice_count_after": 7,
    }
