...
from app.application.workflow_routing_pass import WorkflowRoutingStateHints, build_workflow_routing_pass


def test_workflow_routing_pass_routes_budget_query_to_general_chat() -> None:
    result = build_workflow_routing_pass(
...
def test_workflow_routing_pass_routes_explicit_meal_logging_to_intake() -> None:
    result = build_workflow_routing_pass(
...
def test_workflow_routing_pass_routes_recommendation_request() -> None:
    result = build_workflow_routing_pass(
...
def test_workflow_routing_pass_routes_rescue_action_when_open_proposal_exists() -> None:
    result = build_workflow_routing_pass(
...
def test_workflow_routing_pass_routes_body_observation_create() -> None:
    result = build_workflow_routing_pass(
...
def test_workflow_routing_pass_routes_calibration_request() -> None:
    result = build_workflow_routing_pass(
...
def test_workflow_routing_pass_uses_pending_followup_for_intake_continue() -> None:
    result = build_workflow_routing_pass(
...
def test_workflow_routing_pass_keeps_ambiguous_turn_in_general_chat() -> None:
    result = build_workflow_routing_pass(
        raw_user_input="先這樣吧",
        state_hints=WorkflowRoutingStateHints(),
    )
