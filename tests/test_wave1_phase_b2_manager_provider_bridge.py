...
@pytest.mark.asyncio
async def test_b2_manager_provider_bridge_uses_explicit_provider_item_results_without_local_fallback() -> None:
...
@pytest.mark.asyncio
async def test_b2_manager_provider_bridge_passes_clarify_support_outside_packet_lane() -> None:
...
@pytest.mark.asyncio
async def test_b2_manager_provider_bridge_does_not_author_item_results_when_provider_omits_them() -> None:
    intent, consumption = _tea_egg_packet_consumption()
...
@pytest.mark.asyncio
async def test_b2_manager_provider_bridge_flags_forbidden_mutation_fields_without_executing_them() -> None:
    intent, consumption = _tea_egg_packet_consumption()
    explicit_item_results = [
        {
            "interpreted_food_identity": "茶葉蛋",
