...
def _gsw1_trace_case() -> dict[str, object]:
    return {
        ...
        "trace_id": "trace-gsw1",
        "prompt_registry": {"manager_prompt_version": "v18"},
        "current_turn_context_packet": {"current_turn": "exact FoodDB hit", "pending_question": None},
        "react_trace": {
            "manager_pass_1": {"decision_payload": {"workflow_effect": "commit"}},
            "requested_tools": ["fooddb.lookup"],
            "executed_tools": ["fooddb.lookup"],
            "manager_pass_final": {"decision_payload": {"workflow_effect": "commit"}},
            "guard_result": {"mutation_allowed": True},
            "total_latency_ms": 12000,
            "tool_call_count": 1,
        },
        "filtered_tool_plan": {"allowed_tools": ["fooddb.lookup"]},
        "compact_packets": [{"packet_id": "matsuya-tokumori", "source_role": "exact_fooddb"}],
        "mutation_result": {"mutation_allowed": True},
        "renderer_input_basis": {"today_consumed_updates": True},
        "final_response_basis": {"basis": "exact_fooddb_packet"},
        "runtime": {
            "workflow_effect": "commit",
            "websearch_tool_call_expected": False,
            "exact_fooddb_packet_used": True,
        ...
        "ui": {
            "today_consumed_updates": True,
            "frontend_nutrition_math_allowed": False,
            "exact_fooddb_basis_visible": True,
        },
        "response": {
            "visible_text": "?? FoodDB ??????????",
            "zh_tw_primary": True,
