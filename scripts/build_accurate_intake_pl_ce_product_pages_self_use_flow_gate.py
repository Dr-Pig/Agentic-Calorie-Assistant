...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build the PL+CE product-pages self-use flow gate from existing artifacts."
    )
    parser.add_argument(
        "--artifact",
        action="append",
    ...
    parser.add_argument(
        "--output",
        default="artifacts/accurate_intake_pl_ce_product_pages_self_use_flow_gate.json",
    )
