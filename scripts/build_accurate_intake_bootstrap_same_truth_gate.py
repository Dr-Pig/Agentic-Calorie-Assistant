...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--output", default="artifacts/accurate_intake_bootstrap_same_truth_gate.json")
    ...
    artifact = build_bootstrap_same_truth_gate_artifact(
        browser_smoke_artifact=json.loads(Path(args.browser_smoke_json).read_text(encoding="utf-8")),
    ...
    return 0 if artifact["status"] == BOOTSTRAP_SAME_TRUTH_READY_STATUS else 1
