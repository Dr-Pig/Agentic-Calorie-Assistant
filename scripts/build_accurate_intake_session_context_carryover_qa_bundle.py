...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build the Accurate Intake short-term session context carryover QA bundle."
    )
    parser.add_argument(
        "--artifact",
        action="append",
    ...
    parser.add_argument(
        "--output",
        default="artifacts/accurate_intake_session_context_carryover_qa_bundle.json",
    )
    ...
    artifact = build_session_context_carryover_qa_bundle_artifact(
