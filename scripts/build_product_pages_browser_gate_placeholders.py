...
PLACEHOLDER_ARTIFACTS = (
    ...
    "artifacts/accurate_intake_current_shell_compatibility_context_coverage_matrix_ci.json",
    ...
    "artifacts/accurate_intake_current_shell_compatibility_ui_context_alignment_pack_ci.json",
    "artifacts/accurate_intake_current_shell_compatibility_local_mvp_candidate_bundle_ci.json",
    "artifacts/accurate_intake_current_shell_fixture_e2e_ci.json",
    ...
    "artifacts/accurate_intake_current_shell_compatibility_merge_queue_metadata_ci.json",
)
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Write placeholder artifacts for fast-pass or blocked-upstream product pages jobs."
    )
