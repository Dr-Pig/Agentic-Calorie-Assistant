...
from app.nutrition.application.websearch_live_search_canary_report import (  # noqa: E402
    build_websearch_live_search_canary_report,
)
from app.shared.infra.json_artifacts import read_json_artifact, write_json_artifact  # noqa: E402


DEFAULT_CANARY = ROOT / "artifacts" / "accurate_intake_websearch_live_search_diagnostic_canary.json"
DEFAULT_OUTPUT = ROOT / "artifacts" / "accurate_intake_websearch_live_search_canary_report.json"


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build WebSearch live-search canary report without runtime activation."
    )
