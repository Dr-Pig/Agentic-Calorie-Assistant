...
DEFAULT_OUTPUT = ROOT / "artifacts" / "accurate_intake_fooddb_retrieval_policy.json"


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build a report-only FoodDB retrieval policy artifact."
    )
        ...
        json.dumps(
            {
                ...
                "runtime_anchor_indexed_count": artifact["summary"][
                    "runtime_anchor_indexed_count"
                ],
            },
            ensure_ascii=False,
        )
