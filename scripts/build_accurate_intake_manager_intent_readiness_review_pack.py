...
DEFAULT_ARTIFACT_PATHS = {
    ...
    "contextual_interaction_matrix": ROOT
    / "artifacts"
    / "accurate_intake_contextual_interaction_matrix.json",
    "fake_provider_context_smoke": ROOT
    / "artifacts"
    / "accurate_intake_fake_provider_context_smoke.json",
    "responder_input_contract_fake_smoke": ROOT
    / "artifacts"
    / "accurate_intake_responder_input_contract_fake_smoke_ci.json",
    "context_coverage_matrix": ROOT
    / "artifacts"
    / "accurate_intake_pl_ce_context_coverage_matrix.json",
    "session_context_carryover_qa_bundle": ROOT
    / "artifacts"
    / "accurate_intake_session_context_carryover_qa_bundle.json",
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build the PL+CE Manager intent readiness review pack from existing artifacts."
    )
    parser.add_argument(
        "--artifact",
        action="append",
    ...
    parser.add_argument(
        "--output",
        default="artifacts/accurate_intake_manager_intent_readiness_review_pack.json",
    )
        ...
        json.dumps(
            {
                ...
                "ready_for_live_diagnostic_decision": artifact[
