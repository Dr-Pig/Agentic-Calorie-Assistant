...
from app.nutrition.application.fooddb_packet_mutation_guard_readiness import (  # noqa: E402
...
DEFAULT_OUTPUT = ROOT / "artifacts" / "accurate_intake_fooddb_packet_mutation_guard_readiness.json"


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build FoodDB packet-to-mutation-guard readiness artifact."
    )
    ...
    artifact = build_fooddb_packet_mutation_guard_readiness(
        ...
        json.dumps(
            {
                ...
                "mutation_changed": artifact["mutation_changed"],
