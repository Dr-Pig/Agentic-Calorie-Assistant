...
from app.composition.accurate_intake_product_pages_ui_review_bundle import (  # noqa: E402
    REQUIRED_INPUTS,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build the Accurate Intake product pages UI review bundle from existing artifacts."
    )
    parser.add_argument(
        "--artifact",
        action="append",
    ...
    parser.add_argument(
        "--output",
        default="artifacts/accurate_intake_product_pages_ui_review_bundle.json",
    )
    ...
    artifact = build_product_pages_ui_review_bundle_artifact(
