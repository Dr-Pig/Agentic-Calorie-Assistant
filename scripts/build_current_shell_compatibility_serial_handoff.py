...
DEFAULT_QUEUE_JSON_PATH = (
    ROOT / "artifacts" / "accurate_intake_current_shell_compatibility_merge_queue_metadata.json"
)
DEFAULT_OUTPUT_PATH = (
    ROOT / "artifacts" / "accurate_intake_current_shell_compatibility_serial_handoff.json"
)
