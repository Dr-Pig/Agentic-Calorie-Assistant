...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--output",
        default="artifacts/accurate_intake_product_pages_renderer_source_closure_gate.json",
    )
    ...
    return 0 if artifact["status"] == "product_pages_renderer_source_closure_ready_for_browser" else 1
