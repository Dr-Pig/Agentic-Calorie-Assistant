...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build PL+CE browser activation evidence gate from existing browser artifacts."
    )
    parser.add_argument(
        "--artifact",
        action="append",
    ...
    parser.add_argument(
        "--output",
        default="artifacts/accurate_intake_pl_ce_browser_activation_evidence_gate.json",
    )
