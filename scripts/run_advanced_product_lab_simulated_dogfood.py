...
from app.advanced_shadow_lab.product_lab_simulated_summary import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Run the deterministic advanced product-lab dogfood scenario."
    )
    parser.add_argument("--output-root", required=True)
    parser.add_argument("--summary-output", required=True)
    parser.add_argument("--session-id", default="advanced-product-lab-simulated-dogfood")
